...
namespace UGESystem
{
    ...
    public class CharacterDatabase : ScriptableObject
    {
        ...
        public void UpdateCharacter(string targetID, CharacterData sourceData)
        {
            ...
            {
                // When performing a full update from a template, we record the sourceData's CharacterID as the template ID.
                target.UpdateData(sourceData.Name, sourceData.Is3D, sourceData.Prefab, sourceData.Expressions, sourceData.CharacterID);
            }
        }
        ...
        public void FromJson(string json)
        {
            ...
            foreach (var dto in dtoList)
            {
                ...
                if (existingCharacter != null)
                {
                    ...
                    existingCharacter.UpdateData(dto.Name, dto.Is3D, existingCharacter.Prefab, newExpressions, dto.SourceTemplateID);
                }
                else
                {
                    ...
                    newCharacter.UpdateData(dto.Name, dto.Is3D, null, newExpressions, dto.SourceTemplateID);
